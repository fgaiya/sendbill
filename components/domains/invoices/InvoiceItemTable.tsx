...
import { InvoiceItemRow, InvoiceItemRowRef } from './InvoiceItemRow';
...
export interface InvoiceItemTableProps {
  ...
  fieldArray: UseFieldArrayReturn<InvoiceFormWithPaymentData, 'items', 'keyId'>;
...
export function InvoiceItemTable({
  ...
  // 品目行refの管理
  const itemRowRefs = useRef<(InvoiceItemRowRef | null)[]>([]);
