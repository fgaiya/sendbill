...
export const NAV_LINK_BASE_CLASSES = {
  MOBILE: cn(
    'block px-3 py-2',
    APP_CONFIG.UI.BUTTON.BORDER_RADIUS,
    'text-base font-medium',
    APP_CONFIG.ANIMATION.TRANSITION_COLORS,
...
export const BUTTON_CLASSES = {
  MENU_TOGGLE: cn(
    'text-gray-700 hover:text-gray-900 p-2',
    APP_CONFIG.UI.BUTTON.BORDER_RADIUS,
    APP_CONFIG.ANIMATION.TRANSITION_COLORS,
    APP_CONFIG.UI.FOCUS.RING
  ),
  ...
  SECONDARY: cn(
    APP_CONFIG.UI.BUTTON.REGULAR_SECONDARY,
    APP_CONFIG.UI.FOCUS.RING
  ),
} as const;
...
export const SIDEBAR_ITEM_CLASSES = {
  ...
  LABEL: cn(
    APP_CONFIG.UI.SPACING.COMPONENT_GAP,
    APP_CONFIG.ANIMATION.TRANSITION_OPACITY
  ),
